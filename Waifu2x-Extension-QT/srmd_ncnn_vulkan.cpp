...
int MainWindow::SRMD_NCNN_Vulkan_Image(int rowNum, bool ReProcess_MissingAlphaChannel)
{
    ...
    QString program = Waifu2x_folder_path + "/srmd-ncnn-vulkan.exe";
    //==========
    ...
    for (int retry = 0; retry < (ui->spinBox_retry->value() + ForceRetryCount); retry++)
    {
        ...
        for (int i = Initial_ScaleRatio; i <= ScaleRatio_tmp; i *= 2)
        {
            ...
            args.append(SrmdNcnnVulkan_ReadSettings());
...
{
    //===
    ui->pushButton_DetectGPUID_srmd->setText("Detecting, please wait...");
    //===
...
void MainWindow::SRMD_DetectGPU_finished()
{
    ...
    //===
    ui->pushButton_DetectGPUID_srmd->setText("Detect available GPU ID");
    //===
}
/*
预读取SRMD引擎设定
*/
QStringList MainWindow::SrmdNcnnVulkan_PreLoad_Settings()
{
    QStringList SrmdNcnnVulkan_Settings_str;
    // TTA
    ...
    if (ui->checkBox_MultiGPU_SrmdNCNNVulkan->isChecked() == false)
    {
        ...
        {
            SrmdNcnnVulkan_Settings_str.append("-g");
            SrmdNcnnVulkan_Settings_str.append(ui->comboBox_GPUID_srmd->currentText());
        }
        // Tile Size
        SrmdNcnnVulkan_Settings_str.append("-t");
        SrmdNcnnVulkan_Settings_str.append(QString::number(ui->spinBox_TileSize_srmd->value(), 10));
    }
    // Model
    ...
    SrmdNcnnVulkan_Settings_str.append("-m");
    SrmdNcnnVulkan_Settings_str.append(model_path);
    SrmdNcnnVulkan_Settings_str.append("-j");
    SrmdNcnnVulkan_Settings_str.append("1:1:1");
    //=======================================
...
读取SRMD引擎设置
*/
QStringList MainWindow::SrmdNcnnVulkan_ReadSettings()
{
    QStringList SrmdNcnnVulkan_Settings_str;
    ...
    if (ui->checkBox_MultiGPU_SrmdNCNNVulkan->isChecked())
    {
        ...
        // GPU ID
        SrmdNcnnVulkan_Settings_str.append("-g");
        SrmdNcnnVulkan_Settings_str.append(GPUInfo["ID"]);
        // Tile Size
        SrmdNcnnVulkan_Settings_str.append("-t");
        SrmdNcnnVulkan_Settings_str.append(GPUInfo["TileSize"]);
    }
    //=======================================
    return SrmdNcnnVulkan_Settings_str;
}
