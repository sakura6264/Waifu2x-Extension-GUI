...
int MainWindow::Realsr_NCNN_Vulkan_Image(int rowNum, bool ReProcess_MissingAlphaChannel)
{
    ...
    QString program = Waifu2x_folder_path + "/realsr-ncnn-vulkan.exe";
    //==========
    ...
    for (int retry = 0; retry < (ui->spinBox_retry->value() + ForceRetryCount); retry++)
    {
        ...
        for (int i = 4; i <= ScaleRatio_tmp; i *= 4)
        {
            ...
            args.append(Realsr_NCNN_Vulkan_ReadSettings());
...
预读取引擎配置
*/
QStringList MainWindow::Realsr_NCNN_Vulkan_PreLoad_Settings()
{
    QStringList Realsr_NCNN_Vulkan_Settings_str;
    if (ui->checkBox_MultiGPU_RealsrNcnnVulkan->isChecked() == false)
    {
        ...
        {
            Realsr_NCNN_Vulkan_Settings_str.append("-g");
            Realsr_NCNN_Vulkan_Settings_str.append(ui->comboBox_GPUID_RealsrNCNNVulkan->currentText());
        }
        // Tile Size
        Realsr_NCNN_Vulkan_Settings_str.append("-t");
        Realsr_NCNN_Vulkan_Settings_str.append(QString::number(ui->spinBox_TileSize_RealsrNCNNVulkan->value(), 10));
    }
    // TTA
    ...
    case 0:
    {
        Realsr_NCNN_Vulkan_Settings_str.append("-m");
        Realsr_NCNN_Vulkan_Settings_str.append(Waifu2x_folder_path + "/models-DF2K_JPEG");
        break;
    }
    case 1:
    {
        Realsr_NCNN_Vulkan_Settings_str.append("-m");
        Realsr_NCNN_Vulkan_Settings_str.append(Waifu2x_folder_path + "/models-DF2K");
        break;
    }
    }
    Realsr_NCNN_Vulkan_Settings_str.append("-j");
    Realsr_NCNN_Vulkan_Settings_str.append("1:1:1");
    //=======================================
...
读取配置生成配置QString
*/
QStringList MainWindow::Realsr_NCNN_Vulkan_ReadSettings()
{
    QStringList Realsr_NCNN_Vulkan_Settings_str;
    ...
    if (ui->checkBox_MultiGPU_RealsrNcnnVulkan->isChecked())
    {
        ...
        // GPU ID
        Realsr_NCNN_Vulkan_Settings_str.append("-g");
        Realsr_NCNN_Vulkan_Settings_str.append(GPUInfo["ID"]);
        // Tile Size
        Realsr_NCNN_Vulkan_Settings_str.append("-t");
        Realsr_NCNN_Vulkan_Settings_str.append(GPUInfo["TileSize"]);
    }
    //=======================================
    return Realsr_NCNN_Vulkan_Settings_str;
}
...
{
    //====
    ui->pushButton_DetectGPU_RealsrNCNNVulkan->setText("Detecting, please wait...");
    //====
...
int MainWindow::Realsr_ncnn_vulkan_DetectGPU_finished()
{
    ...
    //====
    ui->pushButton_DetectGPU_RealsrNCNNVulkan->setText("Detect available GPU ID");
    //====
    return 0;
}
/*
...
void MainWindow::on_checkBox_MultiGPU_RealsrNcnnVulkan_clicked()
{
    if (ui->checkBox_MultiGPU_RealsrNcnnVulkan->isChecked())
    {
        ...
        {
            QMessageBox::information(this,"Error","Insufficient number of available GPUs.");
            ui->checkBox_MultiGPU_RealsrNcnnVulkan->setChecked(0);
            return;
        }
    }
